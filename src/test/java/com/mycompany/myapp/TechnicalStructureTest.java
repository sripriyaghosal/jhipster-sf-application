...
@AnalyzeClasses(packagesOf = JhipsterfApplicationApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterfApplicationApp.class), alwaysTrue())
